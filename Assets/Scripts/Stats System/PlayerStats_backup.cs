...
//     {
//         Debug.Log($"🔄 UpdatePlayerSystems called - VIT: {vitality} (Health handled by UpdateVitalityBonus)");
        
//         // Update PlayerResources mana only (health handled separately by UpdateVitalityBonus)
//         var playerResources = FindObjectOfType<PlayerResources>();
//         if (playerResources != null)
//         {
...
//             Debug.Log($"📊 CALCULATED: MaxMana={MaxMana}");

//             // Store current mana before updating max values  
//             int currentMana = playerResources.GetCurrentMana();
//             int oldMaxMana = playerResources.maxMana;

//             Debug.Log($"📊 PLAYERRESOURCES BEFORE: MP={currentMana}/{oldMaxMana}");

//             // Update max mana only
//             playerResources.maxMana = MaxMana;
            
//             Debug.Log($"📊 SET NEW MAX VALUES: MP={playerResources.maxMana}");

//             // Calculate mana difference
//             int manaDifference = MaxMana - oldMaxMana;

//             Debug.Log($"📊 DIFFERENCE: Mana +{manaDifference}");
...
//             Debug.Log($"📊 FINAL STATE: MP={playerResources.GetCurrentMana()}/{playerResources.maxMana}");
//         }
//         else
//         {
//             Debug.LogError("❌ PlayerResources not found! Cannot update mana from stats.");
//         }
...
//         Debug.Log($"📊 Stats Updated - MP: {MaxMana}, ATK: {AttackDamage}, SPD: {MovementSpeed:F1}");
//     }
